...
print("W")
print(np.max((abs(dldw - grad_W)) / np.clip((abs(grad_W) + abs(dldw)), a_min=e, a_max=5000)))
print("B")
print(np.max((abs(dldb - grad_b)) / np.clip((abs(grad_b) + abs(dldb)), a_min=e, a_max=5000)))
print("V")
print(np.max((abs(dldv - grad_V)) / np.clip((abs(grad_V) + abs(dldv)), a_min=e, a_max=5000)))
print("U")
print(np.max((abs(dldu - grad_U)) / np.clip((abs(grad_U) + abs(dldu)), a_min=e, a_max=5000)))
print("c")
print(np.max((abs(dldc - grad_c)) / np.clip((abs(grad_c) + abs(dldc)), a_min=e, a_max=5000)))
print("done")
